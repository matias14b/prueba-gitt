...
Vue.component('portabilidad-datos-personales', {
    ...
    computed: {
        ...
        esFormularioCodigoPromocional: function () {
            return !this.esFormularioReferido && !this.showBanner && tuenti.ui.views.utils.getParametroUrl("codigoPromocional") != null;
        },
    ...
    methods: {
        ...
        habilitarBotonSiguienteSiCorresponde() {
            // no ponemos el codigo promocional para el nuevo formulario. 
            ...
            if (this.esClienteCompleto && this.esFechaNacimientoValida && (this.esFormatoValidoCodigoReferido || !this.esFormularioReferido)) {
                this.validar();
            } else {
